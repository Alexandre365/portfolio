...
inicializarCertificados = () => {
    ...
    Certificados.map((val) =>{
        ...
        <div class="grid-item" id="${val.id}">
                    <img src="${val.img}"  width="90%" height="150">
                    <h2>
                        ${val.curso}
                    </h2>
                    <h2>
                    ...
                    <b>Click para verificar certificado</b>
            </div>
...
btnCertVoltar.onclick = function () {
    var OCCont = document.getElementById('OCCont')
    OCCont.style.display = 'none'
}

certificadoData.onclick = function(){
    var OCCont = document.getElementById('OCCont')
    var certImg = document.getElementById('certImg')
    OCCont.style.display = 'inline'
